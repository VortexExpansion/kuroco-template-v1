    ...
    <div class="l-container--wrap">
        ...
        <template v-if="$route.query.token != null">
            <form>
                ...
                <div>仮パスワード<input v-model="temp_pass" name="temp_pass" type="" placeholder="temp_pass"></div>
                <div>新しいパスワード<input v-model="new_pass" name="new_pass" type="" placeholder="new_pass"></div>
                <div>新しいパスワードの確認<input v-model="confirm_pass" name="confirm_pass" type="" placeholder="confirm_pass_pass"></div>
